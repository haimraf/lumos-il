-- Improve live-event reward delivery:
-- - rank detection remains points-desc / created_at-asc
-- - numeric rewards come from the live rewards config when present
-- - optional group/title rewards can be driven by config
...
BEGIN
    ...
    LOOP
        ...
        VALUES (winner_row.id, 'achievement', notification_content, false);
