-- Guard distribute_event_rewards from duplicate execution and duplicate notifications.
-- This keeps the RPC idempotent when admins retry, double-click, or race each other.
