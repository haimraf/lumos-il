-- When live rewards are configured, award only the explicitly defined ranks.
-- If no rewards config exists at all, keep the legacy fallback prizes for the top 10.
