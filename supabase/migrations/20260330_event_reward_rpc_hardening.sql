-- Harden reward distribution after the later restore migration overwrote
-- the idempotency guard, and align ranking with the UI by using the higher
-- of event_points / passover_points instead of COALESCE.
