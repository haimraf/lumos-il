...
export const OFFICIAL_SERIES_NOTES: OfficialSeriesNote[] = [
  {
    title: "מועד הבכורה",
    value: "25 בדצמבר 2026",
    detail: "\"אבן החכמים\" עולה ב-HBO ו-HBO Max ביום חג המולד, לפי ההודעה הרשמית.",
  },
  {
    title: "היקף העונה הראשונה",
    value: "שמונה פרקים",
    detail: "ספר אחד לעונה, ובסך הכל שבע עונות מתוכננות לשבעת הספרים.",
  },
  {
    title: "הקו המוצהר",
    value: "עיבוד נאמן יותר לספרים",
    detail: "זה הכיוון הרשמי שהודגש בהודעות ההפקה ובטריילר הראשון.",
  },
  {
    title: "אצלנו בפורום",
