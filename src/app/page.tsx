...
import { Sparkles, Mail, Trophy, Users, Star, ArrowRight, X, Lock, ScrollText, Wand2, Volume2, VolumeX, KeyRound } from "lucide-react";
import { useUIState } from "@/context/UIContext";

/**
 * LUMOS IL - LANDING V14.6 (The CSS-Proof Modal)
 * הוספת Inline Style כדי לנצח את ההגבלות של globals.css ולשמור על מודאל צר ויוקרתי.
 */
...
export default function Home() {
  ...
  if (isCheckingSession) return (
    <div className="min-h-screen bg-[#020617] flex flex-col items-center justify-center gap-6">
      <div className="w-16 h-16 border-t-4 border-amber-500 rounded-full animate-spin shadow-[0_0_30px_rgba(245,158,11,0.5)]"></div>
      ...
      <main className="min-h-screen bg-[#020617] text-[#f8fafc] relative overflow-x-hidden font-crimson" dir="rtl">
        ...
        <section className="relative z-10 flex flex-col items-center justify-center min-h-[92vh] px-4 sm:px-6 py-12">
          ...
          <div className="text-center mb-12 animate-float">
            <h1 className="font-cinzel text-5xl sm:text-6xl md:text-[8rem] font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-amber-100 via-amber-400 to-amber-700"
          ...
          <div className="envelope-scene flex flex-col items-center w-full relative max-w-[90vw] md:max-w-[550px]">
                  ...
                  <div className="relative w-full h-[250px] sm:h-[300px] md:h-[360px] rounded-lg overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.7)] border border-amber-900/20"
                    ...
                    <div className="absolute top-[38%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
                      <div className="seal-pulse w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full flex items-center justify-center border-2 border-red-950/30"
                        ...
                        <div className="w-10 h-10 sm:w-14 sm:h-14 md:w-18 md:h-18 rounded-full border border-white/15 flex items-center justify-center font-cinzel text-xl md:text-3xl text-red-100 font-bold select-none">
                          L
                        </div>
                      </div>
                    </div>
                ...
                <div className={`letter-rise w-full ${letterVisible ? 'visible' : ''}`}>
                  ...
                  >
                    <div className="p-6 md:p-12 text-right">
                      ...
                      <div className="flex flex-col items-center mb-8 md:mb-10 border-b border-amber-900/10 pb-6 md:pb-8">
                      ...
                      <div className="space-y-6 md:space-y-8 font-crimson text-lg md:text-2xl leading-relaxed italic">
                        ...
                        <div className="bg-amber-900/[0.04] p-5 md:p-6 rounded-lg border-r-4 border-amber-800/25 my-6 md:my-8 not-italic">
                          <h4 className="font-cinzel text-base md:text-lg font-bold mb-4 uppercase tracking-widest text-amber-950">רשימת ציוד נדרשת:</h4>
                        ...
                        <p className="text-base md:text-lg opacity-70 border-t border-amber-900/10 pt-6">
                      ...
                      <div className="flex flex-col items-center mt-10 md:mt-12 space-y-8">
                        <div className="w-16 h-16 md:w-24 md:h-24 rounded-full flex items-center justify-center border-4 border-red-950/30 transform rotate-[-8deg]"
                          style={{
                            background: 'radial-gradient(circle at 35% 35%, #c0392b, #7b0000)',
                            boxShadow: '0 0 40px rgba(127,0,0,0.35)',
                          }}>
                          <span className="font-cinzel text-white text-3xl md:text-4xl font-bold opacity-90 select-none">L</span>
                        </div>

                        <button
                          onClick={() => setIsModalOpen(true)}
                          className="shimmer-btn group relative w-full text-amber-950 py-5 md:py-7 rounded-md font-cinzel text-lg md:text-2xl font-black shadow-2xl flex items-center justify-center gap-4 transition-transform active:scale-95 hover:scale-[1.01] overflow-hidden"
                        >
            ...
            {/* Easter Egg */}
            <div className="mt-12 md:mt-20 px-4 md:px-6 py-2.5 rounded-full bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.08] hover:border-amber-500/30 transition-all duration-500 cursor-default group flex items-center gap-3 shadow-lg opacity-40 hover:opacity-100">
              <Wand2 size={16} className="text-amber-500/50 group-hover:text-amber-400 transition-colors shrink-0" />
              <span className="font-crimson text-white/50 group-hover:text-white/90 text-xs md:text-base tracking-widest italic transition-colors">
                לחש קטן באפלה: נסו להקליד <kbd className="font-sans font-bold text-amber-500/80 mx-1 drop-shadow-[0_0_5px_rgba(245,158,11,0.5)]">LUMOS</kbd> באוויר...
              </span>
            </div>
        ...
        {/* ===== WITCHES & WIZARDS EMPOWERMENT SECTION ===== */}
        ...
        {/* ===== AUTH MODAL (CSS-PROOF WITH INLINE STYLE) ===== */}
        {isModalOpen && (
          <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
            ...
            {/* ✨ כאן מנצחים את globals.css! משתמשים ב-style כדי לכפות את הרוחב */}
            <div
              className="modal-enter relative w-full max-h-[90vh] overflow-y-auto custom-scrollbar rounded-[2.5rem] border border-amber-500/20 shadow-[0_0_50px_rgba(245,158,11,0.1)] bg-[#050505] p-8 md:p-10 z-10 my-auto"
              style={{ maxWidth: '420px' }}
            >

              <button
                onClick={() => setIsModalOpen(false)}
                className="absolute top-6 left-6 text-white/20 hover:text-amber-500 transition-colors outline-none hover:rotate-90 transition-transform duration-300 bg-white/5 p-2 rounded-full"
              >
                <X size={18} />
              </button>
              ...
              <div className="flex flex-col items-center gap-6 w-full">
                ...
                <div className="text-center space-y-2 mb-2">
                  <h3 className="font-cinzel text-2xl md:text-3xl tracking-tight font-bold text-white">שערי הטירה</h3>
                  <p className="font-crimson text-base text-amber-500/60 italic">הזנת פרטי הקסם שלך</p>
                </div>

                <form onSubmit={handleAuth} className="w-full space-y-5">
                  <div className="space-y-2 text-right">
                    <label className="text-[10px] uppercase tracking-[0.3em] text-white/40 mr-2 font-cinzel">דואר ינשופים</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl pr-12 pl-4 py-3.5 outline-none focus:border-amber-500/50 focus:bg-white/10 transition-all font-crimson text-lg text-white placeholder-white/20"
                  ...
                  <div className="space-y-2 text-right">
                    <label className="text-[10px] uppercase tracking-[0.3em] text-white/40 mr-2 font-cinzel">סיסמת קסם</label>
                    <div className="relative">
                      <div className="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none text-white/20">
                        <KeyRound size={16} />
                      </div>
                  ...
                  >
                    {isLoading ? (
                      <>
                        <div className="w-5 h-5 border-t-2 border-amber-950 rounded-full animate-spin"></div>
                        מטיל לחש...
                      </>
                ...
                <button
                  ...
                  className="mt-2 font-crimson text-white/40 hover:text-white/80 transition-all text-[15px] border-b border-white/20 pb-1 outline-none hover:border-amber-500/50"
                >
