...
export const metadata: Metadata = {
    ...
    description: 'ברוכ׳ הבא׳ לאולם הגדול של לומוס IL! הפורטל המרכזי של קהילת הארי פוטר בישראל. מכאן תוכלו להגיע לספריית הפאנפיקים, לפורומים, לנביא היומי ולחדר המועדון שלכם.',
