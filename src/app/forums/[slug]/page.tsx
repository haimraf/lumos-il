            ...
            >
                ...
                <div className="min-w-0 flex-1">
                    <div className="thread-title-row">
                        ...
                        {/* באדג' נעוץ */}
                        {thread.is_pinned && (
                            <span className="flex items-center gap-1 px-2 py-0.5 rounded bg-amber-500/10 border border-amber-500/30 text-amber-400 text-[9px] font-black uppercase tracking-tighter animate-pulse">
                        ...
                        {/* באדג' חדש - זוהר וירוק */}
                        {isNew && (
                            <span className="px-2 py-0.5 rounded bg-emerald-500 text-emerald-950 text-[9px] font-black uppercase tracking-tighter shadow-[0_0_10px_rgba(16,185,129,0.4)]">
                                NEW
                            </span>
                        )}
                        ...
                        {/* באדג' נעול */}
                        {thread.is_locked && (
                            <span className="flex items-center gap-1 px-2 py-0.5 rounded bg-red-500/10 border border-red-500/30 text-red-400 text-[9px] font-black uppercase tracking-tighter">
                                <Lock size={10} /> נעול
                            </span>
                        )}

                        <span className={`thread-title ${thread.is_pinned ? "text-amber-200/90" : "text-white/90"} ${isNew ? "font-black" : "font-bold"}`}>
                            {thread.title}
                        </span>
                    </div>
