...
import { ChevronDown, Wand2, BookOpen, Feather } from "lucide-react";
...
export default function FAQPage() {
    ...
    const filtered = activeCategory
        ? SITE_FAQ.filter(f => f.category === activeCategory)
        : SITE_FAQ;
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-6 py-20">
                ...
                <header className="text-center mb-16 space-y-6">
                    ...
                    <div>
                        ...
                        <h1 style={{ fontFamily: "'Cinzel', serif", fontWeight: 900, fontSize: "clamp(2.5rem,7vw,5rem)", lineHeight: 1.1, color: "white" }}>
                            מה מסתתר{" "}
                ...
                {/* ── Category Filter ── */}
                <div className="mb-10">
                    <p style={{ fontFamily: "'Cinzel', serif", fontSize: "9px", letterSpacing: "0.35em", color: "rgba(255,255,255,0.2)", textTransform: "uppercase", marginBottom: "14px", textAlign: "center" }}>
                        סנן לפי פרק
                    </p>
                    ...
                    {activeCategory && (
                        <p style={{ fontFamily: "'IM Fell English', serif", fontStyle: "italic", color: "rgba(245,158,11,0.4)", fontSize: "0.85rem", textAlign: "center", marginTop: "10px" }}>
                            ...
                            <button onClick={() => setActiveCategory(null)} style={{ marginRight: "8px", color: "rgba(255,255,255,0.3)", textDecoration: "underline", cursor: "pointer", fontSize: "0.75rem" }}>
                                נקה סינון
                            </button>
                        </p>
                    )}
